...
public class GeraCpfCnpj {
	...
	public String cnpjNovaFilial(boolean comPontos, int a1,int a2,int a3,int a4,int a5,int a6,int a7,int a8) {
		int n = 9;
		...
		int n11 = randomiza(n);
		int n12 = randomiza(n);
		int d1 = n12 * 2 + n11 * 3 + n10 * 4 + n9 * 5 + a8 * 6 + a7 * 7 + a6 * 8 + a5 * 9 + a4 * 2 + a3 * 3 + a2 * 4 + a1 * 5;
		...
		int d2 = d1 * 2 + n12 * 3 + n11 * 4 + n10 * 5 + n9 * 6 + a8 * 7 + a7 * 8 + a6 * 9 + a5 * 2 + a4 * 3 + a3 * 4 + a2 * 5 + a1 * 6;
		...
		if (comPontos)
			retorno = "" + a1 + a2 + "." + a3 + a4 + a5 + "." + a6 + a7 + a8 + "/" + n9 + n10 + n11 + n12 + "-" + d1 + d2;
		else
			retorno = "" + a1 + a2 + a3 + a4 + a5 + a6 + a7 + a8 + n9 + n10 + n11 + n12 + d1 + d2;
